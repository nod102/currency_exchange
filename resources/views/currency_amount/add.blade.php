            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('currency_amount.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="currency_name" id="currency_name">
                                <input type="hidden" name="currency_exchange_name" id="currency_exchange_name">
                                <input type="hidden" name="currency_exchange_value" id="currency_exchange_value">
                                ...
                                <div class="row">
                                        ...
                                        <select name="currency_id" id="currency_id" required class="form-control">
                                            ...
                                            @if($currency_results)
                                                @foreach($currency_results as $currency_result)
                                                    <option value="{{$currency_result->currency_id}}" data-currencyName="{{$currency_result->currency_name}}">{{$currency_result->currency_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="amount" required class="form-control page_num"
                                            id="exampleInputText1" placeholder="الكمية">
                                    </div>
